            ...
            if (!exit)
            {
                connectButton.Invoke((MethodInvoker)delegate
                {
                    ...
                    if (status)
                    {
                        ...
                        connectButton.Text = "Выйти";
                        Log(SystemMsg("Вы присоединились к чату"));
                    }
                    else
                    {
                        ...
                        connectButton.Text = "Зайти";
                        Log(SystemMsg("Вы вышли из чата"));
                    }
                });
            }
        }
        ...
        private void SendTextBox_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                if (sendTextBox.Text.Length > 0)
                {
                    ...
                    sendTextBox.Clear();
                    Log(string.Format("{0}: {1}", obj.username, msg));
                    if (connected)
                    {
                        Send(msg);
                    }
